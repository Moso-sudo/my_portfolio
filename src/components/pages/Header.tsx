...
const SubTitle: React.FC = () => (
  ...
  // >
    <BoxReveal boxColor="#2b82f6" duration={0.5}>
      ...
      <ReactTyped strings={['App Developer,' ,'Smart Contract Developer,', 'Full stack Web Developer,',]}
...
const Header: React.FC = () => {
  return (
    <div className="flex flex-col items-center px-4 gap-10 py-20">
      <div className="text-center my-4">
        <GradientText
          className="font-display text-center font-bold tracking-[-0.05em] text-2xl lg:text-4xl md:p-2"
          text={<WordAnimation />}
        />
